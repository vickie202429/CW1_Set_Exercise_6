        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (loginIDView.getText().length() == 0 || passwordView.getText().length() == 0) {
                    Toast.makeText(EmployeeLoginActivity.this, "Please enter the Login ID and password.",
                            Toast.LENGTH_LONG).show();
                } else {
                    startActivity(new Intent(EmployeeLoginActivity.this, EmployeeMenuActivity.class));
                }
            }
        });
    }
